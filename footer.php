			...
			<div class="row">
				...
				<div class="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
					...
					<div class="subscribe-form">
						<p>নতুন নতুন পোস্ট পাওয়ার জন্য এখনই Subscribe করুন</p>
						<?php echo do_shortcode('[contact-form-7 id="1399" title="Subscribe form"]');?>
					</div>
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="copyright-text">
						<p>Copyright &copy; <?php echo date('Y'); ?> <a href="<?php echo home_url('/'); ?>"> monirecipe.com </a> All Rights Reserved</p>
					</div>
				</div>
			</div>
		</div>
