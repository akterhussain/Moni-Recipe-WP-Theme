...
<main class="main-section">
	<section class="hero-section" style="background-image: url(<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/bg2.webp);">
		...
		<section class="home-witdget-section marzin-top">
			<div class="container">
				<div class="row">
					<div class="col-xl-12">
						<div class="hero-witget-area">
							<?php dynamic_sidebar( 'after_hero_area' ); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="recent-post-section section-padding">
			<div class="container">
				...
				<section class="home-witdget-section marzin-bottom">
					<div class="container">
						<div class="row">
							<div class="col-xl-12">
								<div class="before-gallery-witget">
									<?php dynamic_sidebar( 'before_gallery' ); ?>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="post-gallery-section section-padding">
					...
					<section class="home-witdget-section marzin-top">
						<div class="container">
							<div class="row">
								<div class="col-xl-12">
									<div class="after-gallery-witget">
										<?php dynamic_sidebar( 'after_gallery' ); ?>
									</div>
								</div>
							</div>
						</div>
							...
							// the query
								$popular_post = new WP_Query( array(
									...
									<?php if ( $popular_post->have_posts() ) : ?>
										...
										<?php else : ?>
											<p><?php _e( 'Sorry, no posts matched your criteria.', 'moni-recipe' ); ?></p>
										<?php endif; ?>
